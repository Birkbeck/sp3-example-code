...
### 1.1 Download \"curl\" ([only for systems which do not have it already])
 ...
 [For Mac OS X or other Linux systems, the "Curl\" utility comes with the OS.  Re-installation of \"Curl\" might cause malfunctioning behaviour on Mac OS X or other Linux systems.
