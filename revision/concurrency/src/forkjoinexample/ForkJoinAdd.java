...
// This method is used as a Fork/Join demo only as the recursive loop is painfully slow.
// The Fork/Join framework is designed to handle large amounts of data and is not suitable for small data sets.
